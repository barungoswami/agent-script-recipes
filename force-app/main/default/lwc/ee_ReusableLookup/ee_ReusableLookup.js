...
import fetchRecords from '@salesforce/apex/EE_ReusableLookupController.fetchRecords';
/** The delay used when debouncing event handlers before invoking Apex. */
const DELAY = 500;

export default class Ee_ReusableLookup extends LightningElement {
@api helpText = "Search Facility By Name";
    @api label = "Facility Name";
    @api required;
    ...
    handleSelect(event) {
        ...
        console.log('selectedRecord from child component>>',selectedRecord.id);
